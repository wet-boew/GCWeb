			...
			all:
				options:
					...
					relaxerror: [
						...
						"E017" # GCWeb wants to support explicit labels when using checkbox inputs under the .provisional > .checkbox classes
						"E018" # GCWeb wants to support explicit labels when using radio inputs under the .provisional > .radio classes
					]
				src: [
					"dist/**/*.html"
