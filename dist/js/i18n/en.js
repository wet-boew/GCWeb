...
(function() {
	...
	_pe.dic.ind = {
		...
		'%tab-list': 'Tab list',
		'%tab-panel-end-1': 'End of this tab panel.',
		'%tab-panel-end-2': 'Return to the tab list',
		'%tab-panel-end-3': 'or continue to the rest of page.',
		/* Multimedia player */
		'%play': 'Play',
		'%pause': 'Pause',
		'%open': 'Open',
		...
		'%closed-caption-error': 'Error loading closed captions',
		'%audio-description': {
			'enable': 'Enable audio description',
			'disable': 'Disable audio description'
		},
		'%progress-bar': 'use left and right arrow keys to advance and rewind the media\'s progress',
		...
		'%share-manual': 'Please close this dialog and press Ctrl-D to bookmark this page.',
		...
		/* Slideout */
		'%show-toc': 'Show',
		'%show-text': 'Show table of contents',
		'%hide-text': 'Hide table of contents',
		...
		'%sSortDescending': ': activate for descending sort',
