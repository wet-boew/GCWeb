...
(function() {
	...
	_pe.dic.ind = {
		...
		'%stop': 'Detener',
		'%back': 'Volver',
		'%new-window': ' (Abre en una nueva ventana)',
		...
		'%archived-page': 'Esta página ha sido archivada en la web.',
		/* Menu bar */
		'%sub-menu-help': '(pulse "enter" para abrir el submenú y ciérrelo con la tecla "esc")',
		/* Tabbed interface */
		'%tab-rotation': {
			'disable': 'Detener rotación de pestañas',
			'enable': 'Comenzar rotación de pestañas'
		},
		'%tab-list': 'Lista de pestañas',
		'%tab-panel-end-1': 'Fin de este panel de pestaña.',
		'%tab-panel-end-2': 'Volver a la lista de pestañas',
		'%tab-panel-end-3': 'o continuar al resto de la página.',
		/* Multimedia player */
		'%play': 'Reproducir',
		'%pause': 'Pausa',
		'%open': 'Abrir',
		...
		'%closed-caption-error': 'Error al cargar subtítulos',
		'%audio-description': {
			'enable': 'Habilitar audio descripción ',
			'disable': 'Deshabilitar audio descripción'
		},
		'%progress-bar': 'Usar las flechas IZQUIERDA y DERECHA para avanzar o retroceder la presentación multimedia',
		...
		'%percentage': 'Porcentaje de reproducción:',
		'%duration': 'Tiempo total:',
		'%buffered': 'Almacenado en memoria intermedia:',
		/* Share widget */
		'%favourite': 'Favorito',
		...
		'%share-email-body': 'Pienso que te podría interesar esta página:\n{t} ({u})',
		'%share-fav-title': '(marcar página como favorita)',
		'%share-manual': 'Cierre esta notificación y presione Ctrl-D para marcar esta página como favorita.',
		'%share-showall': 'Mostrar todo ({п})',
		'%share-showall-title': 'Todos los sitios marcados como favoritos',
		...
		'%datepicker-show': 'Escoger una fecha de un calendario para el campo:',
		...
		/* Slideout */
		'%show-toc': 'Mostrar',
		'%show-text': 'Mostrar el índice',
		'%hide-text': 'Ocultar el índice',
		'%table-contents': 'índice',
		/* Lightbox */
		'%lb-current': 'Artículo {current} de {total}',
		'%lb-next': 'Artículo siguiente',
		'%lb-prev': 'Artículo previo',
		'%lb-xhr-error': 'Este contenido no pudo ser cargado.',
		'%lb-img-error': 'Esta imagen no pudo ser cargada.',
		'%lb-slideshow': 'show de diapositivas',
		/* jQuery Mobile */
		'%jqm-expand': 'hacer clic para expandir el contenido',
		'%jqm-collapse': 'hacer clic para colapsar los contenidos',
		'%jqm-clear-search': 'limpiar búsqueda',
		'%jqm-filter': 'filtrar artículos',
		'%jqm-tbl-col-toggle': 'Columnas...',
		/* Charts widget */
		'%table-mention': 'Tabla',
		'%table-following': 'Cuadro. Los detalles aparecen en la siguiente tabla.',
		/* Session timeout */
		'%st-timeout-msg': 'Su sesión está por a expirar. Tiene hasta #expireTime# para activar el botón "OK" y así extender su sesión.',
		'%st-msgbox-title': 'Aviso de finalización de sesión',
		'%st-already-timeout-msg': 'Lo sentimos, su sesión ha expirado. Por favor ingrese nuevamente.',
		/* Toggle details */
		...
		/* Table enhancement */
		'%sSortAscending': 'active para ordenar en sentido ascendente',
		'%sSortDescending': 'active para ordenar en sentido decendente',
		...
		/* Disable/enable PE */
		'%pe-disable': 'Versión HTML básica',
		'%pe-enable': 'Versión estándar'
	};
