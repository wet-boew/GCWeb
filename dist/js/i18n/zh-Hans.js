...
(function() {
	...
	_pe.dic.ind = {
		...
		'%tab-list': '标签列表',
		'%tab-panel-end-1': '此选项卡面板的结束。',
		'%tab-panel-end-2': '返回到标签列表',
		'%tab-panel-end-3': '或继续其余的页面。',
		/* Multimedia player */
		'%play': '播放',
		'%pause': '暂停',
		'%open': '打开',
		...
		'%calendar-goToLink': '转到<span class="wb-invisible">月份的一年</span>',
		'%calendar-goToTitle': '转到月份的一年',
		...
		/* Session timeout */
		'%st-timeout-msg': '您的会话即将到期。你必须等到＃expireTime＃激活下面的“OK”按钮，以扩大您的会话。',
		'%st-msgbox-title': '会话超时警告',
		'%st-already-timeout-msg': '很抱歉，您的会话已经过期。请重新登录。',
		/* Toggle details */
		'%td-toggle': '切换所有',
		'%td-open': '展开全部',
		'%td-close': '关闭全部',
		...
		'%sEmptyTable': '没有可用的数据表中的',
		'%sInfo': '显示_START_到_END_的_TOTAL_10个项目',
		'%sInfoEmpty': '显示0到0的0个项目',
		'%sInfoFiltered': '（共_MAX_项过滤）',
		'%sInfoThousands': ',',
