...
(function() {
	...
	_pe.dic.ind = {
		...
		'%tab-list': '籤頁列表',
		'%tab-panel-end-1': '此籤頁選項結束。',
		'%tab-panel-end-2': '返回到籤頁列表',
		'%tab-panel-end-3': '或繼續其餘的頁面。',
		/* Multimedia player */
		'%play': '播放',
		'%pause': '暫停',
		'%open': '打開',
		...
		'%closed-caption-error': '載入字幕錯誤',
		'%audio-description': {
			'enable': '有音訊說明',
			'disable': '無音訊說明'
		},
		'%progress-bar': '使用左或右箭頭鍵來前進或倒轉音訊資料',
		...
		'%calendar': '日曆',
		'%calendar-currentDay': '現在日期',
		'%calendar-goToLink': '轉到<span class="wb-invisible">月份的一年</span>',
		'%calendar-goToTitle': '轉到某年的某月份',
		...
		/* Session timeout */
		'%st-timeout-msg': '您的這段連線即將到期。你必須等到＃expireTime＃點選下面的『OK』按鈕，以延長您的連線。',
		'%st-msgbox-title': '連線超時警告',
		'%st-already-timeout-msg': '很抱歉，您的連線已經過期。請重新登錄。',
		/* Toggle details */
		'%td-toggle': '切換所有',
		'%td-open': '展開全部',
		'%td-close': '關閉全部',
		...
		/* Table enhancement */
		'%sSortAscending': ': 使用大小排序',
		'%sSortDescending': '：使用小大排序',
		'%sEmptyTable': '沒有可用的數據',
		'%sInfo': '顯示_START_到_END_的_TOTAL_個項目',
		'%sInfoEmpty': '顯示0到0的0個項目',
		'%sInfoFiltered': '（共_MAX_項過濾）',
		'%sInfoThousands': ',',
		'%sLengthMenu': '顯示_MENU_項',
		/* Geomap */
		'%geo-mapcontrol': '地圖控制',
		'%geo-zoomin': '放大',
		'%geo-zoomout': '缩小',
