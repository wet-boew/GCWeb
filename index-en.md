...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-md-auto pull-right">
			<p><a href="https://github.com/wet-boew/GCWeb/archive/v10.4.0.zip" class="btn btn-primary">Download GCWeb theme <strong>v10.4.0</strong></a><br />
				<small>(<time>{{ page.dateModified | %F }}</time> - <a href="https://github.com/wet-boew/gcweb/releases/tag/v10.4.0">Release notes</a>)</small></p>
		</div>
	</div>
</div>
